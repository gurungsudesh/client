                                        ...
                                        <!-- Yo chai post ko content-->
                                            ...
                                            <div class="toppost">
                                                <table id="posttable" >
                                                        ...
                                                        <td style="width:20px"><button  class="btn btn-success" style="float:right; color:green; background-color:white; border:none;"><i class="fas fa-trash-alt"></i></button></td>
                                                    </tr>
                                                    <tr>
